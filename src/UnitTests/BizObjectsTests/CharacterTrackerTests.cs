...
namespace BizObjectsTests
{
    ...
    public class CharacterTrackerTests
    {
        ...
        public void WhoLineSticks()
        {
            ...
            tracker.TrackLine((dynamic)_parser.ParseLine(new LogDatum("[Mon May 27 06:40:15 2019] You bite Khronick for 2877 points of damage.")));
        ...
        public void HealOfPlayerDetectsMercenary()
        {
            ...
            tracker.TrackLine((dynamic)_parser.ParseLine(new LogDatum("[Mon May 27 06:40:40 2019] Khronick glows with health. Movanna healed Khronick for 7034 (7296) hit points by Healing Splash.")));
